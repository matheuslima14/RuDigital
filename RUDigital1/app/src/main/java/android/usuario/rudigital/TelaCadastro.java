...
public class TelaCadastro extends AppCompatActivity {
    ...
    private void getWebService() {
        ...
        final Request request = new Request.Builder().url("http://172.50.0.178:802/appRUDigital/CadastroUsuario.php?nome=" + nome + "&email=" + email + "&senha=" + senha + "&matriculasiape=" + matriculasiape + "&rg=" + rg + "&confirmaSenha" + confirmaSenha).build();
