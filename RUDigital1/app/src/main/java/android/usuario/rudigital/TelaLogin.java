...
public class TelaLogin extends AppCompatActivity {
    ...
    private void getWebService() {
        ...
        final Request request = new Request.Builder().url("http://pedrofjduarte.000webhostapp.com/appRUDigital/LoginUsuario.php?matriculasiape=" + matriculasiape + "&senha=" + senha).build();
