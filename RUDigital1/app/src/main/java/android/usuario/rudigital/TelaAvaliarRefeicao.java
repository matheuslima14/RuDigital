...
public class TelaAvaliarRefeicao extends AppCompatActivity {
    ...
    private void getWebService() {
        ...
        final Request request = new Request.Builder().url("http://pedrofjduarte.000webhostapp.com/appRUDigital/AvaliarServico.php?matriculasiape=" + matriculasiape + "&notaAtribuidaAlmoco=" + notaatribuidaalmoco + "&notaAtribuidaJanta=" + notaatribuidajanta).build();
    ...
    private void getWebServiceBuscarNotas() {
        ...
        final Request request = new Request.Builder().url("http://pedrofjduarte.000webhostapp.com/appRUDigital/ExibirAvaliacao.php?matriculasiape=" + matriculasiape).build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
