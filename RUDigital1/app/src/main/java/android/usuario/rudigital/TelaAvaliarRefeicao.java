...
public class TelaAvaliarRefeicao extends AppCompatActivity {
    ...
    private void getWebService() {
        ...
        final Request request = new Request.Builder().url("http://172.50.0.178:802/appRUDigital/AvaliarServico.php?matriculasiape=" + matriculasiape + "&notaAtribuidaAlmoco=" + notaatribuidaalmoco + "&notaAtribuidaJanta=" + notaatribuidajanta).build();
    ...
    private void getWebServiceBuscarNotas() {
        ...
        final Request request = new Request.Builder().url("http://172.50.0.178:802/appRUDigital/ExibirAvaliacao.php?matriculasiape=" + matriculasiape).build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
